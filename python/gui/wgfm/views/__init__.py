...
def getViewSettings():
	return ( ViewSettings(WGFM_BATTLE_INJECTOR_UI, View, 'wgfmBattle.swf', ViewTypes.WINDOW, None, ScopeTemplates.GLOBAL_SCOPE),
			 ViewSettings(WGFM_BATTLE_COMPONENTS_UI, WGFMBattleView, None, ViewTypes.COMPONENT, None, ScopeTemplates.DEFAULT_SCOPE),
			 ViewSettings(WGFM_LOBBY_WINDOW_UI, WGFMLobbyView, 'wgfmLobby.swf', ViewTypes.WINDOW, None, ScopeTemplates.GLOBAL_SCOPE) )
