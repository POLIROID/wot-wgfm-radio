...
from gui.wgfm.wgfm_constants import PLAYER_STATUS, DEFAULT_BINDINGS, UI_VOLUME_MULTIPLIYER

__all__ = ('WGFMLobbyViewMeta', )

class WGFMLobbyViewMeta(View, AbstractViewMeta):
...
class WGFMLobbyView(WGFMLobbyViewMeta):
	...
	def __generateHotkeysCtx(self):
		...
		if not g_dataHolder.settings.get('isModpack', False):
			keySetNames.append('broadcastHello')
