package poliroid.gui.lobby.net_radio.events
{
	...
	public class NetRadioEvent extends Event
	{
		...
		public function NetRadioEvent(type:String, bubbles:Boolean = true, cancelable:Boolean = false)
		{
		...
		{
			return new NetRadioEvent(type, bubbles, cancelable);
		}
	}
}
