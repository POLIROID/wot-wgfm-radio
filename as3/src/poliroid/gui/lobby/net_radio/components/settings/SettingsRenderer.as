package poliroid.gui.lobby.net_radio.components.settings 
{
	...
	import poliroid.gui.lobby.net_radio.data.SettingItemVO;
	...
	public class SettingsRenderer extends UIComponentEx
	{
		...
		private function handleSettingsItemClick(e:Event) : void 
		{
			...
			dispatchEvent(new NetRadioValueEvent(NetRadioValueEvent.SETTINGS_CHANGED, target.name, target.selected));
		}
